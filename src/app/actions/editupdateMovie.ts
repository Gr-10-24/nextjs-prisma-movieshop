...
/* */
    return movies.map(movie => ({
        ...
        price: movie.price instanceof Prisma.Decimal ? movie.price.toNumber() : Number(movie.price),// Convert price to number
        stock: movie.stock,
...
export async function UpdateTodo(
  ...
  try {
    ...
    return {
      ...
      data: {
          ...updatedMovie,
          price: updatedMovie.price instanceof Prisma.Decimal 
