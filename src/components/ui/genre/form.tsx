          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input  className="border border-black mb-6" placeholder="Genre Name..." {...field}  disabled={isPending}/>
                </FormControl>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  ...
                  rows={4}
                  placeholder="description of the genre" {...field} 
                  onChange= {(e)=>{
                    field.onChange(e); 
