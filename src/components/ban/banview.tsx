...
export default function ViewBan({ data }: { data:User}){
    ...
    return(
                    <TableRow>
                        ...
                        <TableCell><Button  onClick={() =>UpdateTodo(data.id).then(() =>
                                        toast({
                                           title: "unban successful",
                                             variant: "destructive",
                                                  })
                                        )
                                         } className="bg-blue-500 hover:bg-green-700 text-white font-bold py-1 px-3 border border-green-700 rounded ">Unban</Button>
                        </TableCell>
                    </TableRow>
